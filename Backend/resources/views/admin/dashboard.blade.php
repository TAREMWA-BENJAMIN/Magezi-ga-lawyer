...
<div id="app">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <button class="nav-btn" data-view="practice-areas" id="nav-practice-areas">
        <span class="nav-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <div class="main">
    ...
    <main class="content">
      ...
      <!-- ── PRACTICE AREAS VIEW ──────────────────────────────────────────── -->
      <section class="view" id="view-practice-areas">
...
function renderPracticeAreas() {
  document.getElementById('practice-areas-tbody').innerHTML = (data.practiceAreas || []).map(p => `
    <tr>
...
function editPracticeArea(id) {
  ...
  if (id) {
    const p = data.practiceAreas.find(x => x.id === id);
    if (p) {
