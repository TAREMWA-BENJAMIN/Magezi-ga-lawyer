    ...
    <footer className="site-footer" role="contentinfo">
      <div className="footer-content">
        <div className="footer-section footer-brand">
          ...
          <p className="footer-tagline">
            Bridging the gap between Ugandan citizens and the legal system since 2009.
            We believe that understanding your rights should never be complicated.
          </p>
        </div>
        ...
        <div className="footer-section footer-contact">
          ...
          <div className="contact-details">
            <div className="contact-detail-item">
              ...
              <a href="tel:+256791862269">+256 791 862 269</a>
            </div>
            <div className="contact-detail-item">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <a href="mailto:info@magezi.ug">info@magezi.ug</a>
            </div>
            <div className="contact-detail-item">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <span>Plot 15, Parliamentary Avenue, Kampala, Uganda</span>
            </div>
          </div>
        </div>
      ...
      <div className="footer-emergency">
        <div className="emergency-content">
          ...
          <span>
            <strong>Emergency Legal Support:</strong> If you are in immediate danger or need urgent legal help, call{' '}
            <a href="tel:+256791862269">+256 791 862 269</a> — available 24/7.
          </span>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        ...
        <p>Empowering Ugandans with accessible legal knowledge.</p>
      </div>
    </footer>
  )
}
